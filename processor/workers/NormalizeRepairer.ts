...
export default class NormalizeRepairer {
    ...
    constructor(minAgeMs?: number, nsqClient?: NSQClient, registry?: monkit.Registry, maxEvents?: number) {
    ...
    public async repairOldEvents() {
        ...
        const resp = await pg.query(NormalizeRepairer.selectFromIngestTask, [this.minAgeMs, this.maxEvents]);
        if (!resp.rows.length) {
